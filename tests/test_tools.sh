...
# Ask jb to write a file and then read it back
_out=$(echo "Write the text 'hello from jb test' to /tmp/_jb_test_file.txt, then read it back to confirm. Reply with the content you read." | "$JB" 2>/dev/null)
